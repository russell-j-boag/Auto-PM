...
# Save samples
save(samples, samples1, file = "samples/sAutoPM_B_sdvS.RData")
...
#                       report = 10)
# # Save samples
# save(samples, samples1, samples2, file = "samples/sAutoPM_B_sdvS.RData")


# Sampling plots ----------------------------------------------------------

# Load samples
load("samples/sAutoPM_B_sdvS.RData")
